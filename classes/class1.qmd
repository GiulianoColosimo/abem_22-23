...
A single nucleotide takes approximately one byte (i.e., 8-bit) of memory (this is may vary based on the type of encoding used by the system, but it is a good approximation).

![Binary code principle for nucleotides as implemented in the *ape* package [@Paradis2012]](../images/class1/bit_level_scheme.png)
