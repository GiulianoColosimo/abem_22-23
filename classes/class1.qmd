...
Back in the days, biologists could analyze their small and manageable data on their personal computers. With classic [Sanger Sequecing](https://en.wikipedia.org/wiki/Sanger_sequencing) we were able to amplify anywhere between 50 and 1000 nucleotides (i.e., reatively short fragments).

##

```{r seq_cost,echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Drop of sequencing cost for Genomes and Nucleotides"}
