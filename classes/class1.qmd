...
-   Visit the [R](https://cran.r-project.org) page and download the version compatible to your OS. Install the software following the instructions.

-   Visit the [RStudio](https://www.rstudio.com/products/rstudio/download/) page and download the desktop version compatible with your OS. Install the software following the instructions.
